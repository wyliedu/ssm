            ...
            <div id="page-inner">
				...
				<div class="col-md-12">
					<div class="panel panel-default">
										<div class="panel-body">      		师傅名称：<input type="text" class="" id="name_q" name="name_q"> &nbsp;&nbsp;&nbsp;&nbsp;
      		师傅电话：<input type="text" class="" id="phone_q" name="phone_q">&nbsp;&nbsp;&nbsp;&nbsp;

  			<button class="btn btn-primary query">查询</button></div>
						<div class="panel-heading">师傅列表 
						<!-- <button class="btn btn-success pull-right addBtn"><i class="glyphicon glyphicon-plus"></i>邀请新的师傅</button> -->
						</div>
						<div class="panel-body">
							<table class="table table-bordered table-striped table-hover">
								...
								<th class="text-center" style="background: #3499db; color: #ffffff; width: 10%;">师傅名称</th>
								<th class="text-center" style="background: #3499db; color: #ffffff; width: 10%;">团队名称</th>
				...
				<div class="modal-body">
					<form class="form-horizontal baseform" role="form">
						<div class="form-group">
							<label class="col-sm-3 control-label">师傅手机号：</label>
...
$(function() {
	$(".table").dataTable({
		...
		ajax:  {//类似jquery的ajax参数，基本都可以用。
			...
			url: "/stb-web/senior/seniorlist.do",
			dataType: "json",
	    ...
	    columns: [//对应上面thead里面的序列
	              ...
	              { data: function (e) {//这里给最后一列返回一个操作列表
	                    ...
	                    sContent = sContent+'<a class="btn btn-info" href="/stb-web/senior/update?teamid='+e.teamid+'">修改</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="/stb-web/apprentice/index?teamid='+e.teamid+'">徒弟</a>&nbsp;&nbsp;&nbsp;<button class="btn btn-danger delete">删除</button>'; 
	                    return sContent;
	                }, "sClass" : "text-center"
	              }
	    ] ,
...
$(document).on('click','.using',function(){
	...
	$.ajax( {
		...
		async:false,   //设置为同步
		url : "/stb-web/senior/usingSenior.do",//请求的uri
...
$(".summit").click(function () {
	if($(".baseform").valid()){
		$.ajax( {
			type:"post",//不写此参数默认为get方式提交
			async:false,   //设置为同步
			url : "/stb-web/senior/sendMsgcodeToSenior.do",//请求的uri
			data : {
